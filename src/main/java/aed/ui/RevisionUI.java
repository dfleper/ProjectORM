...
public class RevisionUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        // El combo se rellena manualmente (ver cargarCochesEnCombo())
    ...
    private void limpiarCampos() {
        ...
        if (jComboIdCoche.getItemCount() > 0) {
            jComboIdCoche.setSelectedIndex(0);
        }
        txtFiltro.setText("");
        txtAceite.setText("");
        txtFrenos.setText("");
    ...
    private void cargarCochesEnCombo() {
        try {
            List<Coche> coches = new CocheJpaController().findCocheEntities();
            DefaultComboBoxModel<Coche> model = new DefaultComboBoxModel<>(coches.toArray(new Coche[0]));
            jComboIdCoche.setModel(model);
            if (model.getSize() > 0) {
                jComboIdCoche.setSelectedIndex(0);
            }
        } catch (Exception e) {
            // Si la BD no está disponible, al menos no rompas la UI
            jComboIdCoche.setModel(new DefaultComboBoxModel<>());
        }
    }
...
// Variables declaration - do not modify//GEN-BEGIN:variables
    ...
    private javax.swing.JComboBox<aed.map.Coche> jComboIdCoche;
