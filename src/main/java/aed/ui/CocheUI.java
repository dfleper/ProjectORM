...
public class CocheUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        // UI normal (sin NetBeans BeansBinding)
        ...
        // El icono se carga desde resources en loadIcons()
    ...
    private void limpiarCampos() {
        txtIdCoche.setText("");
        if (jComboIdCliente.getItemCount() > 0) {
            jComboIdCliente.setSelectedIndex(0);
        }
        txtMarca.setText("");
        txtModelo.setText("");
        txtColor.setText("");
    ...
    private void cargarClientesEnCombo() {
        try {
            List<Cliente> clientes = new ClienteJpaController().findClienteEntities();
            DefaultComboBoxModel<Cliente> model = new DefaultComboBoxModel<>(clientes.toArray(new Cliente[0]));
            jComboIdCliente.setModel(model);
            if (model.getSize() > 0) {
                jComboIdCliente.setSelectedIndex(0);
            }
        } catch (Exception e) {
            // Si la BD no está disponible, al menos no rompas la UI
            jComboIdCliente.setModel(new DefaultComboBoxModel<>());
        }
    }
    ...
    private void guardarCoche() {
        Cliente seleccionado = (Cliente) jComboIdCliente.getSelectedItem();
        if (seleccionado == null) {
            JOptionPane.showMessageDialog(this, "No hay clientes cargados. Crea un cliente primero.");
            return;
        }
        coche.setIdCliente(seleccionado);
    ...
    /** Carga iconos desde resources (funciona al clonar y al empaquetar en JAR). */
    private void loadIcons() {
        lblMercedes.setIcon(icon("/aed/ui/img/logo_lettersx56.png"));
    }

    private javax.swing.ImageIcon icon(String resourcePath) {
        java.net.URL url = getClass().getResource(resourcePath);
        return (url != null) ? new javax.swing.ImageIcon(url) : new javax.swing.ImageIcon();
    }
...
// Variables declaration - do not modify//GEN-BEGIN:variables
    ...
    private javax.swing.JComboBox<aed.map.Cliente> jComboIdCliente;
